...
namespace CourseOPR.Controllers
{
    public class FacultiesController : Controller
    {
        ...
        public FacultiesController(ApplicationContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Faculty != null ? 
                          ...
                          Problem("Entity set 'ApplicationContext.Faculty'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ApplicationContext.Faculty'  is null.");
            }
            var faculty = await _context.Faculty.FindAsync(id);
            if (faculty != null)
            {
